...
class _UserInfoEditState extends State<UserInfoEdit> {
      ...
      body: Form(
          child: ListView(
            ...
            children: [
              Column(
                children: [
                  _textField(_nameController, "이름", "이름", "이름"),
                  _textField(_emailController, "이메일", "이메일", "이메일",),
                  _textField(_phoneController, "주소", "주소", "주소"),
                  RaisedButton(
                      child: Text('편집',
  ...
  Widget _textField(dynamic controller, String hintText, String labelText, String name) {
    return ListTile(
      title: TextFormField(
